/*
  ...
  - Added the required column `founder_avatar` to the `resources` table without a default value. This is not possible if the table is not empty.
  - Added the required column `founder_nickname` to the `resources` table without a default value. This is not possible if the table is not empty.
  - Added the required column `modifier_avatar` to the `resources` table without a default value. This is not possible if the table is not empty.
  - Added the required column `modifier_nickname` to the `resources` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `resources` ADD COLUMN `founder_avatar` VARCHAR(255) NOT NULL,
    ADD COLUMN `founder_nickname` VARCHAR(20) NOT NULL,
    ADD COLUMN `modifier_avatar` VARCHAR(255) NOT NULL,
    ADD COLUMN `modifier_nickname` VARCHAR(20) NOT NULL,
    MODIFY `create_time` DATETIME NOT NULL,
