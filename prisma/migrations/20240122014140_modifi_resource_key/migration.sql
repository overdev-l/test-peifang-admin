/*
  ...
  - You are about to alter the column `category_status` on the `resources` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `TinyInt`.
...
ALTER TABLE `resources` MODIFY `create_time` DATETIME NOT NULL,
    ...
    MODIFY `category_status` TINYINT NOT NULL DEFAULT 1;
