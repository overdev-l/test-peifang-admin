/*
  ...
  - Added the required column `company_id` to the `admin_users` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `admin_users` ADD COLUMN `company_id` VARCHAR(255) NOT NULL,
